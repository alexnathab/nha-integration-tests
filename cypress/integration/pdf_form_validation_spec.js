...
describe(`Submits empty form but is unable to move on and is prompted with red outline on required fields`, function () {
    ...
    it(`Clicks the Get Trip Details CTA`, function () {
    ...
    it(`Prompted with red outline in required fields`, function () {
        cy.get('#form-pdf').find('#first_name').should('have.class', 'js-invalid');
        cy.get('#form-pdf').find('#last_name').should('have.class', 'js-invalid');
        cy.get('#form-pdf').find('#email').should('have.class', 'js-invalid');
