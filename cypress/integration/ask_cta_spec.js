...
describe(`Trip Internal Link CTA Test from overview page / detail button`, function () {
    it(`Clicks details CTA, fills out the form, and submits it`, function () {
        cy.visit(`${dev_sites[2].prefix}nathab.com/africa/the-great-namibia-wildlife-safari/?banner&utm_source=testutmsrc&utm_medium=testurmmed&utm_content=testutmcont&utm_campaign=testutmcamp&utm_term=TEST`);
